  ...
  return (
    <section id="Contato">
        <div className='Container'>
          <MotionReveal width='100%'><h1>Contato<span>.</span></h1></MotionReveal>
          ...
          <MotionReveal width='100%'><Link to={'mailto:barros.adelson101@gmail.com'}><BsEnvelope />barros.adelson101@gmail.com</Link></MotionReveal>
        </div>
    </section>
  )
}
