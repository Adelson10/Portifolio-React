  ...
  return (
    <section id="Contato">
        <div className='Container'>
          ...
          <MotionReveal><p>Envie-me um e-mail se quiser entrar em contato! Você também pode me encontrar no <strong><Link to={'https://www.linkedin.com/in/adelson-barros-561a1a24a/'} target='_blank'>LinkedIn</Link></strong> ou <strong><Link to={'https://api.whatsapp.com/send/?phone=1993577423&text&type=phone_number&app_absent=0'} target='_blank'>WhatsApp</Link></strong>, conforme sua preferência.</p></MotionReveal>
