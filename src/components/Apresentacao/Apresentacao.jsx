  ...
  return (
    <section id="Inicio" className="Apresentacao">
        <div className="Apresentacao__Sociais">
            ...
            <MotionLeft index={1}><a href="https://api.whatsapp.com/send/?phone=11993577423&text&type=phone_number&app_absent=0" target="_blank"><BsWhatsapp size={'1.5rem'}/></a></MotionLeft>
        ...
        <div className="Apresentacao_Texto">
            ...
            <MotionReveal><Button icon={<BsSend />} href='https://api.whatsapp.com/send/?phone=11993577423&text&type=phone_number&app_absent=0' >Chama ai</Button></MotionReveal>
            { (width >= 960) &&
            (<MotionReveal>
